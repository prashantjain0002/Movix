...
import Genres from "../../components/carousel/Genres.jsx";
import CircleRating from "../../components/carousel/CircleRating.jsx";
          ...
          {!!data && (
            <React.Fragment>
              <div className="bg-img">
                <Img src={url.background + data.backdrop_path} />
              </div>
